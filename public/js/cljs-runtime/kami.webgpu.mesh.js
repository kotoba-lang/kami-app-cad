...
var n__5593__auto___22627 = (4);
var c_22628 = (0);
while(true){
if((c_22628 < n__5593__auto___22627)){
var n__5593__auto___22629__$1 = (4);
var r_22630 = (0);
while(true){
if((r_22630 < n__5593__auto___22629__$1)){
(o[((c_22628 * (4)) + r_22630)] = (((((a[r_22630]) * (b[((c_22628 * (4)) + (0))])) + ((a[(r_22630 + (4))]) * (b[((c_22628 * (4)) + (1))]))) + ((a[(r_22630 + (8))]) * (b[((c_22628 * (4)) + (2))]))) + ((a[(r_22630 + (12))]) * (b[((c_22628 * (4)) + (3))]))));

var G__22631 = (r_22630 + (1));
r_22630 = G__22631;
continue;
} else {
}
...
kami.webgpu.mesh.translation_matrix = (function kami$webgpu$mesh$translation_matrix(p__22457){
var vec__22458 = p__22457;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22458,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22458,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22458,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = (1));
...
kami.webgpu.mesh.scale_matrix = (function kami$webgpu$mesh$scale_matrix(p__22464){
var vec__22465 = p__22464;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22465,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22465,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22465,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = x);
 ...
 */
kami.webgpu.mesh.model_matrix = (function kami$webgpu$mesh$model_matrix(p__22506){
var map__22507 = p__22506;
var map__22507__$1 = cljs.core.__destructure_map(map__22507);
var translation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22507__$1,new cljs.core.Keyword(null,"translation","translation",-701621547),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var rotation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22507__$1,new cljs.core.Keyword(null,"rotation","rotation",-1728051644),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22507__$1,new cljs.core.Keyword(null,"scale","scale",-230427353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(1),(1)], null));
var vec__22513 = rotation;
var rx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22513,(0),null);
var ry = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22513,(1),null);
var rz = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22513,(2),null);
 ...
 */
kami.webgpu.mesh.upload_texture_BANG_ = (function kami$webgpu$mesh$upload_texture_BANG_(p__22528,p__22529){
var map__22530 = p__22528;
var map__22530__$1 = cljs.core.__destructure_map(map__22530);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22530__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22531 = p__22529;
var map__22531__$1 = cljs.core.__destructure_map(map__22531);
var bytes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22531__$1,new cljs.core.Keyword(null,"bytes","bytes",1175866680));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22531__$1,new cljs.core.Keyword(null,"mime-type","mime-type",1058646439));
 ...
 */
kami.webgpu.mesh.upload_mesh_BANG_ = (function kami$webgpu$mesh$upload_mesh_BANG_(p__22548,p__22549){
var map__22550 = p__22548;
var map__22550__$1 = cljs.core.__destructure_map(map__22550);
var context = map__22550__$1;
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22550__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22551 = p__22549;
var map__22551__$1 = cljs.core.__destructure_map(map__22551);
var geometry = map__22551__$1;
var positions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"positions","positions",-1380538434));
var normals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"normals","normals",-1508109067));
var indices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"indices","indices",-1218138343));
var uvs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"uvs","uvs",1776835110));
var morph_target_deltas = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"morph-target-deltas","morph-target-deltas",-1534652085));
var joints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"joints","joints",-1993525003));
var weights = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22551__$1,new cljs.core.Keyword(null,"weights","weights",-1097626197));
...
var n__5593__auto___22664 = vcount;
var i_22665 = (0);
while(true){
if((i_22665 < n__5593__auto___22664)){
var base_22667 = (i_22665 * (16));
var p_22668 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(positions,i_22665);
var n_22669 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(normals,i_22665);
var uv_22670 = ((has_uv_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(uvs,i_22665):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0], null));
var j_22671 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(joints,i_22665):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(0)], null));
var w_22672 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(weights,i_22665):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [1.0,0.0,0.0,0.0], null));
interleaved.set(kami.webgpu.mesh.f32(p_22668),base_22667);

interleaved.set(kami.webgpu.mesh.f32(n_22669),(base_22667 + (3)));

interleaved.set(kami.webgpu.mesh.f32(uv_22670),(base_22667 + (6)));

joints_view.set((new Uint32Array(cljs.core.clj__GT_js(cljs.core.vec(j_22671)))),(base_22667 + (8)));

interleaved.set(kami.webgpu.mesh.f32(w_22672),(base_22667 + (12)));

var G__22673 = (i_22665 + (1));
i_22665 = G__22673;
continue;
} else {
}
...
(kami.webgpu.mesh.draw_BANG_.cljs$core$IFn$_invoke$arity$8 = (function (p__22581,pass,p__22582,mvp,color,morph_weights,joint_matrices,p__22583){
var map__22584 = p__22581;
var map__22584__$1 = cljs.core.__destructure_map(map__22584);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var pipe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"pipe","pipe",336575849));
var default_texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"default-texture","default-texture",1829125666));
var default_sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"default-sampler","default-sampler",1041755191));
var map__22586 = p__22582;
var map__22586__$1 = cljs.core.__destructure_map(map__22586);
var idx_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"idx-count","idx-count",-1289353607));
var vbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"vbuf","vbuf",303950747));
var morph_deltas_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"morph-deltas-buf","morph-deltas-buf",-129639776));
var ibuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"ibuf","ibuf",801056512));
var joint_matrices_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"joint-matrices-buf","joint-matrices-buf",-625207643));
var vertex_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"vertex-count","vertex-count",1997450535));
var morph_weights_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"morph-weights-buf","morph-weights-buf",-451235347));
var gbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"gbuf","gbuf",897732527));
var morph_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"morph-count","morph-count",-176849136));
var joint_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22586__$1,new cljs.core.Keyword(null,"joint-count","joint-count",663399985));
var map__22587 = p__22583;
var map__22587__$1 = cljs.core.__destructure_map(map__22587);
var color_b = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"color-b","color-b",-988878341),color);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"kind","kind",-717265803),(0));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0,0.0,0.0], null));
var texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22587__$1,new cljs.core.Keyword(null,"texture","texture",-266291651));
var sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22587__$1,new cljs.core.Keyword(null,"sampler","sampler",2068889864));
var shade_kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"shade-kind","shade-kind",-1825128023),(0));
var toon_threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"toon-threshold","toon-threshold",-2084408130),0.4);
var toon_smooth = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22587__$1,new cljs.core.Keyword(null,"toon-smooth","toon-smooth",-1986013699),0.08);
...
var gview_22688 = (new Uint32Array(gdata.buffer));
(gview_22688[(24)] = vertex_count);

(gview_22688[(25)] = morph_count);

(gview_22688[(26)] = joint_count);

(gview_22688[(27)] = kind);

(gview_22688[(32)] = shade_kind);
...
var map__22622 = viewport;
var map__22622__$1 = cljs.core.__destructure_map(map__22622);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var queue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"queue","queue",1455835879));
var ctx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"ctx","ctx",-493610118));
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var mesh_context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"mesh-context","mesh-context",832369712));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22622__$1,new cljs.core.Keyword(null,"height","height",1025178622));
